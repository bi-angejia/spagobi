...
import it.eng.spagobi.dataset.cache.impl.sqldbcache.test.mysql.MySqlSQLDBCacheMetadataTest;
import it.eng.spagobi.dataset.cache.impl.sqldbcache.test.postgres.PostgresSQLDBCacheMetadataTest;
...
public class SQLDBCacheMetadataTestSuite extends TestCase {
	static public Test suite() {
		...
		if(TestConstants.enableTestsOnPostgres){
			suite.addTestSuite(PostgresSQLDBCacheMetadataTest.class);
		}
//		if(TestConstants.enableTestsOnOracle){
//			suite.addTestSuite(OracleSQLDBCacheMetadataTest.class);
//		}
//		if(TestConstants.enableTestsOnSQLServer){
//			suite.addTestSuite(SQLServerSQLDBCacheMetadataTest.class);
//		}
		return suite;
	}
}
