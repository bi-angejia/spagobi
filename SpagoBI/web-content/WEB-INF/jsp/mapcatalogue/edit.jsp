...
<%@ page import="javax.portlet.PortletURL,
				 ...
				 java.util.List,
				 java.util.Iterator,it.eng.spago.base.SourceBean,it.eng.spago.security.IEngUserProfile,it.eng.spagobi.commons.SingletonConfig,it.eng.spagobi.commons.utilities.PortletUtilities" %>
