...
public class ArtifactServiceSoapBindingStub extends org.apache.axis.client.Stub implements it.eng.spagobi.services.artifact.stub.ArtifactService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("getArtifactContentByNameAndType");
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "getArtifactContentByNameAndTypeReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[0] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getArtifactContentById");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in1"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://xml.apache.org/xml-soap", "DataHandler"));
        oper.setReturnClass(javax.activation.DataHandler.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getArtifactContentByIdReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[1] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getArtifactsByType");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in1"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in2"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:spagobiartifact", "ArrayOf_tns2_SpagoBIArtifact"));
        oper.setReturnClass(it.eng.spagobi.services.artifact.bo.SpagoBIArtifact[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getArtifactsByTypeReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[2] = oper;
    ...
    public ArtifactServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ArtifactServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ArtifactServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://bo.artifact.services.spagobi.eng.it", "SpagoBIArtifact");
            cachedSerQNames.add(qName);
            cls = it.eng.spagobi.services.artifact.bo.SpagoBIArtifact.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("urn:spagobiartifact", "ArrayOf_tns2_SpagoBIArtifact");
            cachedSerQNames.add(qName);
            cls = it.eng.spagobi.services.artifact.bo.SpagoBIArtifact[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://bo.artifact.services.spagobi.eng.it", "SpagoBIArtifact");
    ...
    public javax.activation.DataHandler getArtifactContentByNameAndType(java.lang.String in0, java.lang.String in1, java.lang.String in2, java.lang.String in3) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:spagobiartifact", "getArtifactContentByNameAndType"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0, in1, in2, in3});
  ...
  throw axisFaultException;
    ...
    public javax.activation.DataHandler getArtifactContentById(java.lang.String in0, java.lang.String in1, java.lang.Integer in2) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:spagobiartifact", "getArtifactContentById"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0, in1, in2});
  ...
  throw axisFaultException;
    ...
    public it.eng.spagobi.services.artifact.bo.SpagoBIArtifact[] getArtifactsByType(java.lang.String in0, java.lang.String in1, java.lang.String in2) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:spagobiartifact", "getArtifactsByType"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0, in1, in2});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (it.eng.spagobi.services.artifact.bo.SpagoBIArtifact[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (it.eng.spagobi.services.artifact.bo.SpagoBIArtifact[]) org.apache.axis.utils.JavaUtils.convert(_resp, it.eng.spagobi.services.artifact.bo.SpagoBIArtifact[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
